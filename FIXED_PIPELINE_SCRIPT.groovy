pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'geetasree0103/todolist-app'
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                // Use explicit Git checkout instead of SCM
                git branch: 'master', url: 'https://github.com/GeetaSree13/MainProject-Phase2.git'
                
                // Verify checkout worked
                sh 'pwd'
                sh 'ls -la'
                sh 'ls -la TodoListProject/'
            }
        }
